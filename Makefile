...
MODULES_pocsense = -lsense -lwavelet3 -liter -llinops
MODULES_nlinv = -lnoir -liter
MODULES_bpsense = -lsense -lwavelet3 -lnoncart -liter -llinops
...
MODULES_threshold = -llowrank -lwavelet3 -liter -ldfwavelet -llinops
